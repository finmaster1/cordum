...
func (s *server) registerRoutes(mux *http.ServeMux) error {
	...
	s.registerRoute(mux, "GET /api/v1/chat/healthz", s.instrumented("/api/v1/chat/healthz", s.handleLLMChatProxy))
	s.registerRoute(mux, "POST /api/v1/chat", s.instrumented("/api/v1/chat", s.handleLLMChatProxy))
