  ...
  return (
    <div className="space-y-6">
      <PageHeader
        label="Platform"
        title="Schema Detail"
        subtitle="View and edit schema definition"
        actions={
      ...
      >
        <div className="flex flex-col items-center text-center max-w-lg mx-auto">
          ...
          <h3 className="font-display font-bold text-lg text-foreground mb-2">Schema Detail</h3>
          <p className="text-sm text-muted-foreground leading-relaxed mb-6">
            Inspect the full schema definition including fields, types, validation rules, and usage across workflows.
          </p>
