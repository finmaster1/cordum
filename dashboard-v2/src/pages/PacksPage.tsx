  ...
  return (
    <div className="space-y-6">
      <PageHeader
        label="Platform"
        title="Packs"
        subtitle="Browse, install, and manage Cordum Packs"
        actions={
      ...
      >
        <div className="flex flex-col items-center text-center max-w-lg mx-auto">
          ...
          <h3 className="font-display font-bold text-lg text-foreground mb-2">Packs</h3>
          <p className="text-sm text-muted-foreground leading-relaxed mb-6">
            Pre-built agent capabilities and integrations from the Cordum ecosystem. Install packs to extend your agents with new tools, schemas, and workflows.
          </p>
