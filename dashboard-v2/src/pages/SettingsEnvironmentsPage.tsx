    ...
    <div className="space-y-6">
      ...
      >
        <div className="flex flex-col items-center text-center max-w-lg mx-auto">
          ...
          <h3 className="font-display font-bold text-lg text-foreground mb-2">Environments</h3>
          <p className="text-sm text-muted-foreground leading-relaxed mb-6">
            Configure staging, production, and custom environments with isolated configuration, secrets, and policy sets.
          </p>
