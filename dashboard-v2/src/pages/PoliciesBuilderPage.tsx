/*
 * DESIGN: "Control Surface" — Rule Builder
  ...
  return (
    <div className="space-y-6">
      <PageHeader
        label="Safety"
        title="Rule Builder"
        subtitle="Create new policy rules"
        actions={
      ...
      >
        <div className="flex flex-col items-center text-center max-w-lg mx-auto">
          ...
          <h3 className="font-display font-bold text-lg text-foreground mb-2">Rule Builder</h3>
          <p className="text-sm text-muted-foreground leading-relaxed mb-6">
            Define conditions, actions, and scopes for new safety rules. Rules are evaluated in priority order against every agent action.
          </p>
