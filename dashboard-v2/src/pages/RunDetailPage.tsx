/*
 * DESIGN: "Control Surface" — Run Detail
...
import { Play, ArrowLeft, Construction } from "lucide-react";
  ...
  return (
    <div className="space-y-6">
      <PageHeader
        label="Core"
        title="Run Detail"
        subtitle="Inspect workflow execution"
        actions={
      ...
      >
        <div className="flex flex-col items-center text-center max-w-lg mx-auto">
          ...
          <h3 className="font-display font-bold text-lg text-foreground mb-2">Run Detail</h3>
          <p className="text-sm text-muted-foreground leading-relaxed mb-6">
            View the full execution trace of a workflow run including step timings, input/output payloads, and decision points.
          </p>
