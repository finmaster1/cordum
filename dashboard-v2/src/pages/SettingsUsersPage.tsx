    ...
    <div className="space-y-6">
      ...
      >
        <div className="flex flex-col items-center text-center max-w-lg mx-auto">
          ...
          <h3 className="font-display font-bold text-lg text-foreground mb-2">Users & RBAC</h3>
          <p className="text-sm text-muted-foreground leading-relaxed mb-6">
            Manage user accounts, assign roles (admin, operator, viewer), and configure team-level permissions for dashboard access.
          </p>
