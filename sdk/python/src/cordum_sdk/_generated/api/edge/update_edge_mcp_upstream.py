...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: Dict[str, Any] = {
        "method": "put",
        "url": "/api/v1/edge/mcp/upstreams/{name}".format(
            name=name,
        ),
    }
...
def sync_detailed(
    ...
    *,
    ...
    """Update an upstream MCP server entry
     ...
     Updates a tenant-scoped upstream MCP registry entry and stores a best-effort backup of the prior
    entry before overwrite.
