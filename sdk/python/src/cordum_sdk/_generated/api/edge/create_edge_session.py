...
from ...models.edge_session_create_request import EdgeSessionCreateRequest
from ...models.edge_session_create_response import EdgeSessionCreateResponse
...
) -> Optional[Union[Any, EdgeSessionCreateResponse]]:
    if response.status_code == 201:
        response_201 = EdgeSessionCreateResponse.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[Any, EdgeSessionCreateResponse]]:
    return Response(
...
def sync(
    *,
    ...
    Returns:
        Union[Any, EdgeSessionCreateResponse]
    """
