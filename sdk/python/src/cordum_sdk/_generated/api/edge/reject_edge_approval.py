...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: Dict[str, Any] = {
        "method": "post",
        "url": "/api/v1/edge/approvals/{approval_ref}/reject".format(
...
def sync_detailed(
    ...
    *,
    ...
    r"""Reject an Edge action approval

     Resolves a pending Edge approval as rejected. Requires approval/admin permission, enforces tenant
    scope and self-approval protection, and fails with 409 if the referenced Edge
    session/execution/event is stale.
