...
from ...models.list_edge_session_events_decision import ListEdgeSessionEventsDecision
...
def _get_kwargs(
    ...
    *,
    ...
    decision: Union[Unset, ListEdgeSessionEventsDecision] = UNSET,
    ...
    _kwargs: Dict[str, Any] = {
        "method": "get",
        "url": "/api/v1/edge/sessions/{session_id}/events".format(
...
def sync_detailed(
    ...
    *,
    ...
    """List Edge events for a session
     ...
     Returns tenant-scoped events across executions in the session with cursor pagination and optional
    kind, decision, and RFC3339 time-window filters.
    ...
    Args:
        ...
        decision (Union[Unset, ListEdgeSessionEventsDecision]):
