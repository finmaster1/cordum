...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: Dict[str, Any] = {
        "method": "get",
        "url": "/api/v1/approvals/{job_id}/context".format(job_id=job_id,),
    }
...
def _parse_response(*, client: Union[AuthenticatedClient, Client], response: httpx.Response) -> Optional[Union[Any, GetApprovalContextResponse200]]:
...
def _build_response(*, client: Union[AuthenticatedClient, Client], response: httpx.Response) -> Response[Union[Any, GetApprovalContextResponse200]]:
    return Response(
