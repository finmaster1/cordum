...
export function PolicyFirewallView({
  ...
  if (parsed.error) {
    return (
      <div className="rounded-2xl border border-border bg-card/70 p-4 text-sm text-danger">
        <div className="font-semibold">Firewall view unavailable</div>
        <div className="mt-2 text-xs text-muted-foreground">{parsed.error}</div>
        ...
        <div className="space-y-3">
          {rules.map((rule, index) => {
            ...
            return (
              <div
                key={rule.uid}
                className={`rounded-2xl border border-border bg-card/70 p-4 ${isHighlighted ? "ring-2 ring-accent" : ""}`}
              >
                <div className="flex flex-wrap items-center justify-between gap-3">
      ...
      <Drawer open={drawerOpen} onClose={closeDrawer}>
        {draft ? (
          <div className="space-y-5">
            <div>
              <div className="text-xs uppercase tracking-[0.2em] text-muted-foreground">Rule metadata</div>
              <div className="mt-3 grid gap-3 lg:grid-cols-2">
                <div>
                  <label className="text-xs font-semibold uppercase tracking-[0.2em] text-muted-foreground">Rule ID</label>
                  <Input
                    value={draft.id || ""}
                ...
                <div>
                  <label className="text-xs font-semibold uppercase tracking-[0.2em] text-muted-foreground">Decision</label>
                  <Select
            ...
            <div>
              ...
              <div className="mt-3 grid gap-3 lg:grid-cols-2">
                <div>
                  <label className="text-xs font-semibold uppercase tracking-[0.2em] text-muted-foreground">Topics</label>
                  <Input
                ...
                <div>
                  <label className="text-xs font-semibold uppercase tracking-[0.2em] text-muted-foreground">Tenants</label>
                  <Input
                ...
                <div>
                  <label className="text-xs font-semibold uppercase tracking-[0.2em] text-muted-foreground">Capabilities</label>
                  <Input
                ...
                <div>
                  <label className="text-xs font-semibold uppercase tracking-[0.2em] text-muted-foreground">Pack IDs</label>
                  <Input
                ...
                <div>
                  <label className="text-xs font-semibold uppercase tracking-[0.2em] text-muted-foreground">Actor types</label>
                  <Input
                ...
                <div>
                  <label className="text-xs font-semibold uppercase tracking-[0.2em] text-muted-foreground">Actor IDs</label>
                  <Input
                ...
                <div className="lg:col-span-2">
                  <label className="text-xs font-semibold uppercase tracking-[0.2em] text-muted-foreground">Labels (key=value)</label>
                  <Textarea
                    rows={3}
                ...
                <div>
                  <label className="text-xs font-semibold uppercase tracking-[0.2em] text-muted-foreground">Secrets present</label>
                  <Select
                    value={
            ...
            <div>
              ...
              <div className="mt-3 grid gap-3 lg:grid-cols-2">
                <div>
                  <label className="text-xs font-semibold uppercase tracking-[0.2em] text-muted-foreground">Max runtime (ms)</label>
                  <Input
                    type="number"
                ...
                <div>
                  <label className="text-xs font-semibold uppercase tracking-[0.2em] text-muted-foreground">Max retries</label>
                  <Input
                    type="number"
                ...
                <div>
                  <label className="text-xs font-semibold uppercase tracking-[0.2em] text-muted-foreground">Max artifact bytes</label>
                  <Input
                    type="number"
                ...
                <div>
                  <label className="text-xs font-semibold uppercase tracking-[0.2em] text-muted-foreground">Max concurrent jobs</label>
                  <Input
                    type="number"
                ...
                <div>
                  <label className="text-xs font-semibold uppercase tracking-[0.2em] text-muted-foreground">Sandbox isolated</label>
                  <Select
                    value={
                ...
                <div>
                  <label className="text-xs font-semibold uppercase tracking-[0.2em] text-muted-foreground">Network allowlist</label>
                  <Input
                ...
                <div>
                  <label className="text-xs font-semibold uppercase tracking-[0.2em] text-muted-foreground">FS read-only</label>
                  <Input
                ...
                <div>
                  <label className="text-xs font-semibold uppercase tracking-[0.2em] text-muted-foreground">FS read-write</label>
                  <Input
                ...
                <div>
                  <label className="text-xs font-semibold uppercase tracking-[0.2em] text-muted-foreground">Allowed tools</label>
                  <Input
                ...
                <div>
                  <label className="text-xs font-semibold uppercase tracking-[0.2em] text-muted-foreground">Allowed commands</label>
                  <Input
                ...
                <div>
                  <label className="text-xs font-semibold uppercase tracking-[0.2em] text-muted-foreground">Max diff files</label>
                  <Input
                    type="number"
                ...
                <div>
                  <label className="text-xs font-semibold uppercase tracking-[0.2em] text-muted-foreground">Max diff lines</label>
                  <Input
                    type="number"
                ...
                <div className="lg:col-span-2">
                  <label className="text-xs font-semibold uppercase tracking-[0.2em] text-muted-foreground">Diff deny globs</label>
                  <Input
                ...
                <div className="lg:col-span-2">
                  <label className="text-xs font-semibold uppercase tracking-[0.2em] text-muted-foreground">Redaction level</label>
                  <Input
            ...
            <div>
              <div className="text-xs uppercase tracking-[0.2em] text-muted-foreground">Remediations</div>
              <div className="mt-3 space-y-3">
                {(draft.remediations || []).length === 0 ? (
                  <div className="text-xs text-muted-foreground">No remediations attached.</div>
                ) : null}
                {(draft.remediations || []).map((remediation, idx) => (
                  <div key={`${remediation.id || "remediation"}-${idx}`} className="rounded-2xl border border-border bg-card/70 p-3">
                    <div className="flex items-center justify-between">
                      <div className="text-xs font-semibold uppercase tracking-[0.2em] text-muted-foreground">Remediation {idx + 1}</div>
                      <Button
                        variant="outline"
                        size="sm"
                        type="button"
                    ...
                    <div className="mt-3 grid gap-3 lg:grid-cols-2">
                      <div>
                        <label className="text-xs font-semibold uppercase tracking-[0.2em] text-muted-foreground">ID</label>
                        <Input
                      ...
                      <div>
                        <label className="text-xs font-semibold uppercase tracking-[0.2em] text-muted-foreground">Title</label>
                        <Input
                      ...
                      <div className="lg:col-span-2">
                        <label className="text-xs font-semibold uppercase tracking-[0.2em] text-muted-foreground">Summary</label>
                        <Input
                      ...
                      <div>
                        <label className="text-xs font-semibold uppercase tracking-[0.2em] text-muted-foreground">Replacement topic</label>
                        <Input
                      ...
                      <div>
                        <label className="text-xs font-semibold uppercase tracking-[0.2em] text-muted-foreground">Replacement capability</label>
                        <Input
                      ...
                      <div className="lg:col-span-2">
                        <label className="text-xs font-semibold uppercase tracking-[0.2em] text-muted-foreground">Add labels (key=value)</label>
                        <Textarea
                          rows={2}
                      ...
                      <div className="lg:col-span-2">
                        <label className="text-xs font-semibold uppercase tracking-[0.2em] text-muted-foreground">Remove labels</label>
                        <Input
