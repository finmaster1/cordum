...
// ---------------------------------------------------------------------------
// Helpers (copied from InputRulesPage for self-containment)
// ---------------------------------------------------------------------------

function getInputRulesAffordances(canEdit: boolean) {
  return {
    canAddRule: canEdit,
    canEditRule: canEdit,
...
function getInputRuleEditTarget(
  rule: Pick<PolicyRule, "bundle_id">,
): "bundle" | "drawer" {
  return rule.bundle_id ? "bundle" : "drawer";
}

function mapPolicyRuleToInputEditorRule(
  rule: PolicyRule,
...
export default function InputRulesTab({ className }: { className?: string }) {
