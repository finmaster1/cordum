    ...
    <div className="space-y-6">
      <Card>
        <CardHeader>
          ...
          <div className="text-xs text-muted-foreground">Search runs, workflows, packs, and jobs</div>
        </CardHeader>
        <Input
          value={query}
          onChange={(event) => {
                  ...
                  <div key={run.id} className="rounded-2xl border border-border bg-card/70 p-3">
                    <div className="flex items-center justify-between">
                      <div>
                        ...
                        <div className="text-xs text-muted-foreground">Run {run.id.slice(0, 8)}</div>
                      </div>
                  ...
                  <div key={job.id} className="rounded-2xl border border-border bg-card/70 p-3">
                    <div className="flex items-center justify-between">
                      <div>
                        ...
                        <div className="text-xs text-muted-foreground">Topic {job.topic || "-"}</div>
                      </div>
