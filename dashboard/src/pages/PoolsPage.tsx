      ...
      <Card>
        ...
        <div className="grid gap-4 lg:grid-cols-4">
          ...
          <div className="rounded-2xl border border-border bg-card/70 p-4">
            ...
            <div className="text-xs text-muted-foreground">Heartbeat &gt; {STALE_WORKER_MINUTES}m = stale</div>
          </div>
        </div>
      </Card>
                ...
                return (
                  ...
                  >
                    ...
                    {pool.topics.length > 0 ? (
                      ...
                      <div className="mt-3 text-xs text-muted-foreground italic">No topics mapped to this pool</div>
                    )}
                  </button>
                );
              })}
                  ...
                  return (
                    <div
                      ...
                      className={`rounded-xl border p-3 ${
                        isStale ? "border-warning/50 bg-warning/5" : "border-border bg-card/70"
                      }`}
                    >
                      <div className="flex items-center justify-between">
