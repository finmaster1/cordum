...
sidebar_position: 6
title: "SDK Reference"
slug: /api-reference/sdk-reference
---
...
> For the CAP bus protocol and pointer semantics, see [AGENT_PROTOCOL.md](/concepts/agent-protocol).
> For the REST API endpoint reference, see [api-reference.md](/api-reference/full-reference).
...
For details on platform-side HA configuration, see [horizontal-scaling.md](/operations/horizontal-scaling).
...
- [configuration.md](/operations/configuration-guide) — Environment variables and config files
- SCHEDULER_POOL_SPEC.md — Pool routing specification
