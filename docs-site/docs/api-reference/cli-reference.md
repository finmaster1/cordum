...
sidebar_position: 11
title: "CLI Reference"
slug: /api-reference/cli-reference
---
...
For REST API endpoints, see the [REST API reference](/api-reference/full-reference).
For pack format details, see the [Packs documentation](/concepts/packs).
For configuration, see the [Configuration Guide](/operations/configuration-guide).
...
into installable units. See pack.md for the full format specification.
...
- [configuration-reference.md](/operations/config-reference) — Config file reference
