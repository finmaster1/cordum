...
slug: /api-reference/mcp-integration
---
...
- [mcp-server.md](/api-reference/mcp-server) — MCP server operational guide
- [mcp-tools-reference.md](/api-reference/mcp-tools) — Complete tool definitions
- [mcp-resources-reference.md](/api-reference/mcp-resources) — Complete resource definitions
