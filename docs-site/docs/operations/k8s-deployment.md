...
slug: /operations/k8s-deployment
---
...
> For Docker Compose local development, see [DOCKER.md](/getting-started/docker).
> For the production readiness checklist, see [production.md](/operations/production).
> For Helm chart deployment, see [helm.md](/operations/helm).
...
For a complete key inventory, DR runbooks, and base-to-production migration, see [Redis Operations Guide](/operations/redis-operations).
...
See [Horizontal Scaling Guide](/operations/horizontal-scaling) for NATS delivery semantics and multi-replica considerations.
...
- [production.md](/operations/production) — Production readiness guide with DR, runbooks, and scaling
- [production-gate.md](/operations/production-gate) — Automated production gate script
- [configuration.md](/operations/configuration-guide) — Config files and environment variables
- [configuration-reference.md](/operations/config-reference) — Full config schema reference
- [DOCKER.md](/getting-started/docker) — Docker Compose development setup
- [helm.md](/operations/helm) — Helm chart deployment
