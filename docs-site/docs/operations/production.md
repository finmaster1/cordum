...
> For detailed Kubernetes manifest walkthroughs, see [k8s-deployment.md](/operations/k8s-deployment).
...
- [k8s-deployment.md](/operations/k8s-deployment) — Detailed Kubernetes manifest walkthrough
- [configuration.md](/operations/configuration-guide) — Config files and environment variables overview
- [configuration-reference.md](/operations/config-reference) — Complete config schema reference
- [safety-kernel.md](/concepts/safety-kernel) — Safety kernel deep reference
- [scheduler-internals.md](/concepts/scheduler-internals) — Scheduler engine internals
- [output-policy.md](/concepts/output-policy) — Output policy architecture
- [DOCKER.md](/getting-started/docker) — Docker Compose deployment
- [production-gate.md](/operations/production-gate) — Production gate script
